...
[Linkinator Action](https://github.com/step-security/linkinator-action) is the GitHub Actions wrapper for [Linkinator](https://github.com/JustinBeckwith/linkinator). It checks local documentation and remote URLs, annotates failures in the workflow log, and writes a readable job summary.
